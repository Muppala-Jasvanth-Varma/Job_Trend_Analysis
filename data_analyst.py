...
# Preprocessing: Clean 'Salary Estimate'
...
# Check if 'Industry' is encoded; if so, reverse map it
...
# Bar Plot: Top Sectors by Average Salary
...
# Bar Plot: Top Sectors by Job Count
plt.figure(figsize=(12, 6))
sns.barplot(
    data=top_sectors.reset_index(),
    x='Industry',
